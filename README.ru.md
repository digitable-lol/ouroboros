...
Версия <!--state:version-->0.5.0<!--/state-->. Проверки: <!--state:tests-->1248<!--/state--> из <!--state:tests-->1248<!--/state-->, покрытие с ветвями <!--state:coverage_percent-->100<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Установка
