...
| [`tests/`](tests/) | проверок: <!--state:tests-->1072<!--/state--> |
...
Версия <!--state:version-->0.5.0<!--/state-->. Проверки: <!--state:tests-->1072<!--/state--> из <!--state:tests-->1072<!--/state-->, покрытие с ветвями <!--state:coverage_percent-->100<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Установка
