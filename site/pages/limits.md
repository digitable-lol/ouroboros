...
| **Elixir** | `fn` is recorded without its module name. **Build order matters**: the recording module must compile before anything that uses it. Slowest of the eight: three and a half times the next most expensive. |
