...
| [`tests/`](tests/) | tests: <!--state:tests-->1257<!--/state--> |
...
Version <!--state:version-->0.6.1<!--/state-->. Tests: <!--state:tests-->1257<!--/state--> of <!--state:tests-->1257<!--/state-->, branch coverage <!--state:coverage_percent-->100<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Installation
