...
| [`tests/`](tests/) | tests: <!--state:tests-->999<!--/state--> |
...
Version <!--state:version-->0.5.0<!--/state-->. Tests: <!--state:tests-->999<!--/state--> of <!--state:tests-->999<!--/state-->, branch coverage <!--state:coverage_percent-->100<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Installation
