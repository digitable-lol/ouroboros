...
| [`tests/`](tests/) | проверок: <!--state:tests-->441<!--/state--> |
...
Версия 0.2.1. Проверки: <!--state:tests-->441<!--/state--> из <!--state:tests-->441<!--/state-->, покрытие с ветвями <!--state:coverage_percent-->95<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Установка
