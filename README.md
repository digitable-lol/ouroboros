...
| [`tests/`](tests/) | tests: <!--state:tests-->1011<!--/state--> |
...
Version <!--state:version-->0.5.0<!--/state-->. Tests: <!--state:tests-->1011<!--/state--> of <!--state:tests-->1011<!--/state-->, branch coverage <!--state:coverage_percent-->100<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Installation
