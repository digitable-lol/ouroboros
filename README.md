...
Версия 0.2.1. Проверки: <!--state:tests-->580<!--/state--> из <!--state:tests-->580<!--/state-->, покрытие с ветвями <!--state:coverage_percent-->94<!--/state--> % (`ruff`, `mypy --strict`, `pytest`). Установка
