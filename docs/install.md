...
<!--state:version-->0.3.0<!--/state-->: `plugin add` по адресу выше, `list all`
(печатает `0.2.0`, `0.2.1` и `0.3.0`), `install` — после чего наружу вынесены
...
> `pyproject.toml` и сейчас равна `<!--state:version-->0.3.0<!--/state-->`.
