...
средств, 167 проверок. Всё, что показано на страницах, — вывод настоящих
...
но это отдельная сборка поверх этого инструмента. Где страницы говорят о нём, это
названо прямо.

Что известно сломанным: обмазка умеет менять поведение программы, а не только
время её работы — проверенные случаи и то, что уже починено, собраны в
