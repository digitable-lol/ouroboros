...
1. Поставить инструмент — [Установка](install.ru.md).
...
[Справочник средств MCP](mcp-tools.ru.md) — на каждое из семнадцати средств
...
В хранилище лежит навык [`skill/SKILL.md`](https://github.com/digitable-lol/ouroboros/blob/main/skill/SKILL.md)
